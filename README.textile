...
<pre>
bin/plugin -url https://github.com/tmayfield/elasticsearch-jetty/releases/download/1.5.0-beta/elasticsearch-jetty-1.5.0-beta.zip -install elasticsearch-jetty-1.5.0-beta
</pre>
